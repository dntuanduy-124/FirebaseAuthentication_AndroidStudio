...
import com.example.fastdeli.login.MainLoginActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //tu dong load homeFragment
        getSupportFragmentManager().beginTransaction().replace(R.id.activity_container, new HomeFragment()).commit();
    }
